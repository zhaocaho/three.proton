...
//@author mrdoob / http://mrdoob.com/
  ...
  Emitter.prototype.setupParticle = function (particle, initialize, behaviour) {
    ...
    if (initialize) {
      if (Proton.Util.isArray(initialize)) initializes = initialize;
      else initializes = [initialize];
    }

    if (behaviour) {
      if (Proton.Util.isArray(behaviour)) behaviours = behaviour;
  ...
  MeshZone.prototype.getPosition = function () {
    var vertices = this.geometry.getAttribute("position").count;
